...
export default function EditTodoDialog({ todo, open, onOpenChange, onUpdate }: EditTodoDialogProps) {
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Ubah detail tugas sesuai kebutuhan.</DialogDescription>
          </DialogHeader>

          <div className="grid gap-4 py-4">
            <div className="grid gap-2">
              <Label htmlFor="edit-task">Tugas</Label>
              <Input id="edit-task" value={text} onChange={(e) => setText(e.target.value)} autoFocus required />
            </div>
